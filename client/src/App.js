    ...
    <div className="App ">
      <div className={'container justify-content-center main '+page}>
        ...
        <div className="row d-flex w-75 justify-content-between">
          <div className='col-md-7 col-12 col p-0 file text-center ' ><input type="text" className='pt-2 pb-2 w-100' onChange={onChangeInput} placeholder='Paste link to your spreadsheet' /></div>
